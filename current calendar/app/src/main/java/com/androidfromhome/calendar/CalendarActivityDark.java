...
public class CalendarActivityDark extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                ((CalendarAdapter) parent.getAdapter()).getPositionList(selectedGridDate, CalendarActivityDark.this);
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_weather:
                startActivity(new Intent(CalendarActivityDark.this,WeatherActivity.class));
                break;

            case R.id.back_btn:
                startActivity(new Intent(CalendarActivityDark.this,ListViewActivity.class));
                break;
